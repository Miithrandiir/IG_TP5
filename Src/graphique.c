...
static void sol() {
    GLfloat materiel[] = {0.8, 0.8, 0.8, 1.0};
    glMaterialfv(GL_FRONT, GL_AMBIENT_AND_DIFFUSE, materiel);
    glBegin(GL_QUADS);
    {
        glNormal3f(0, 1, 0);
        glVertex3f(1, 0, 1);
...
void dessiner(void) {
    ...
    GLfloat lightWay[] = {0, 10, 0, 1.0};
    glLightfv(GL_LIGHT1, GL_SPOT_DIRECTION, lightWay);
    glLightf(GL_LIGHT1, GL_SPOT_CUTOFF, 11);
